    ...
    <SafeAreaView edges={["top"]} style={styles.root} testID="monetize-screen">
      ...
      {loading ? (
        ...
        <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: insets.bottom + 40 }} keyboardShouldPersistTaps="handled">
          ...
          <Text style={styles.footer}>Your account must be at least 60 days old to monetize. Earnings also require valid traffic — views/clicks from your own or related accounts don't count, and there are daily limits to keep it fair.</Text>
        </ScrollView>
      )}
    </SafeAreaView>
  );
